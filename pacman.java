...
public class pacman {
	public static void main(String[] args) {
		...
		final ImageIcon successIcon = new ImageIcon("src/PacMan/successIcon.png");
		final ImageIcon smallDot = new ImageIcon("src/PacMan/smallDot.png");
		final ImageIcon bigDot = new ImageIcon("src/PacMan/bigDot.png");
		final ImageIcon wall = new ImageIcon("src/PacMan/wall.png");
		final ImageIcon enemy = new ImageIcon("src/PacMan/enemy.png");
		final ImageIcon pacman = new ImageIcon("src/PacMan/pacman.png");
		final ImageIcon empty = new ImageIcon("src/PacMan/empty.png");
